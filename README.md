...
Note that there isn't an official API and the editor methods are prone to changes until that is finalised. With this in mind a good starting place are the following forum threads:
