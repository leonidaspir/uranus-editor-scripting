...
var bootUranusEditor = function () { return __awaiter(_this, void 0, void 0, function () {
    var app, sdkUrl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                app = editor.call("viewport:app");
                sdkUrl = app.assets.find("uranus-editor-sdk.js");
                if (!sdkUrl)
                    return [2 /*return*/];
                return [4 /*yield*/, loadScriptAsync(sdkUrl.getFileUrl())];
            case 1:
                _a.sent();
                startUranusEditor();
                return [2 /*return*/];
...
var startUranusEditor = function () {
